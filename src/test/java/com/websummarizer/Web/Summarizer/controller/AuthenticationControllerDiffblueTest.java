                ...
                .andExpect(MockMvcResultMatchers.content()
                        .string(
                                "{\"id\":1,\"first_name\":\"Jane\",\"last_name\":\"Doe\",\"email\":\"jane.doe@example.org\",\"password\":\"iloveyou\","
                                        ...
                                        + " Selection\",\"enabled\":true,\"accountNonExpired\":true,\"accountNonLocked\":true,\"username\":\"jane.doe@example"
                                        + ".org\",\"credentialsNonExpired\":true}"));
    }
                ...
                .andExpect(MockMvcResultMatchers.content()
                        .string(
                                "{\"user\":{\"id\":0,\"first_name\":null,\"last_name\":null,\"email\":null,\"password\":null,\"phone_number\":null,"
                                        + "\"request_token\":null,\"authorities\":null,\"provider\":null,\"llmSelection\":null,\"enabled\":true,\"accountNonExpired"
                                        + "\":true,\"accountNonLocked\":true,\"username\":null,\"credentialsNonExpired\":true},\"jwt\":\"Invalid email or"
                                        + " password.\"}"));
    }
